...
lambda=1#tumbling parameter

#A=lambda*E+Omega
A11=lambda*Exx+Omegaxx
A12=lambda*Exy+Omegaxy
A21=lambda*Exy+Omegayx
A22=lambda*Eyy+Omegayy
#B=Q+I/3
B11=Qxx+1/3
B12=Qxy
B21=Qxy
...
#C=lambda*E-Omega
C11=lambda*Exx-Omegaxx
C12=lambda*Exy-Omegaxy
C21=lambda*Exy-Omegayx
C22=lambda*Eyy-Omegayy
#D=Q:nabla u
...
S11=(A11*B11+A12*B21)+(B11*C11+B12*C21)-2*lambda*B11*D
S12=A11*B12+A12*B22+(B11*C21+B12*C22)-2*lambda*B12*D
